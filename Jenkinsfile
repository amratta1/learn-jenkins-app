    ...
    stages {
            ...
            stage('E2E') {
             ...
             post{
               always {
                 ...
                 reportName: 'PlayWright local HTML Report',reportTitles: '',useWrapperFileDirectly: true ])
            }
          }
         }
       }
       ...
       stage('prod E2E') {
        ...
        post{
          always {
            publishHTML([ allowMissing: false, alwaysLinkToLastBuild: false, keepAll: false, reportDir: 'playwright-report', reportFiles: 'index.html', 
            reportName: 'PlayWright Prod HTML Report', reportTitles: '', useWrapperFileDirectly: true ])
       }
     }
    }
   }
